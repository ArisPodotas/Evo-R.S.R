...
def main():
	...
	athens = rsr.Population(size = cmd["-size"], generations = cmd["-gen"], reference_sequence = rsr.NCBI_parse(cmd["-acc"], email = "a.Podotas@gmail.com"))
	...
	with open(output_file, 'w') as out_file:
		out_file.write(f"Reference sequence: {rsr.NCBI_parse(cmd['-acc'], email = 'a.Podotas@gmail.com')}\n\nPopulation:\n{generations_output[2]}")
